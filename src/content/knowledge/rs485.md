...
The [IEIO-100 Modbus Remote IO Module](/products/ieio-100-modbus-remote-io-module) is the IoTEdges product reference for wired Modbus Remote IO expansion in distributed cabinet and machine-signal applications.
...
RS485 performance depends on wiring, device count, baud rate, noise environment, grounding and firmware polling behavior. Exact point counts and distance claims should always follow the device datasheet and the real site topology.
